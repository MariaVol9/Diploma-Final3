...
namespace Diploma_Final
{
    public partial class Form6 : Form
    {
        public Form6()
        {
            ...
            label10.Text = "Appointment continuation";
                ...
                for (y = 1; y < 8; y++)
                {
                    if (dataGridView1.Rows[t].Cells[y].Selected == true)
                    {
                        ...
                        while (mySqlDataReader.Read())
                        {
                            ...
                            {
                                tt = mySqlDataReader[2].ToString().Substring(0,5) + "-" + mySqlDataReader[3].ToString().Substring(0,5) + " "+mySqlDataReader2[0].ToString() +" "+ mySqlDataReader2[1].ToString();
