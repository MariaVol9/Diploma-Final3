...
namespace Diploma_Final
{
    public partial class Form5 : Form
    {
        ...
        private void Inventory(DataTable a)
        {
            ...
            dt2.Columns.Add("Purchase Date", typeof(string));            
            dt2.Columns.Add("Category", typeof(string));
            dt2.Columns.Add("Passport", typeof(int));
            ...
            {
                j = 10;
                mySqlCommand.CommandText = "Select * from  inventory where type='"+comboBox1.SelectedItem.ToString()+"'";
            }


            mySqlConnection.Open();
            SqlDataReader mySqlDataReader = mySqlCommand.ExecuteReader();
            string[] table1 = new string[11];
        ...
        private void Button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand mySqlCommand4 = mySqlConnection4.CreateCommand();
                ...
                mySqlCommand3.CommandText = " insert into inventory  values('" + values77[0] + "','" + values77[1] + "','" + values77[2] + "','" + values77[3] + "','" + values77[4] + "','" + textBox3.Text + "','" + values77[6] + "','" + datenew7 + "','" + newst + "'," + value + ")";

            mySqlConnection3.Open();
            numnew = mySqlCommand3.ExecuteNonQuery();
            MessageBox.Show(textBox3.Text.ToString() + " items were purchased");
            mySqlConnection3.Close();
            
            num2 = int.Parse(textBox3.Text);
            mySqlCommand4.CommandText = " update " + newst + "  set Number=Number-"+num2+" where Code= " + strn + "";
