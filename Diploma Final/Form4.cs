    ...
    public partial class Form4 : Form
    {
        ...
        private void Button2_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow row in dataGridView1.SelectedRows)
            {
                ...
                Path.GetFileNameWithoutExtension(path), values[2]);
                ...
                SqlCommand mySqlCommand = mySqlConnection.CreateCommand();
                mySqlConnection.Open();
                mySqlCommand.CommandText = "INSERT INTO patients Values('" + values[0] + "','" + values[1] + "','" + values[2] + "','" + values[3] + "','" + values[4] + "','" + values[5] + "','" + values[6] + "','" + values[7] + "','" + comboBox1.SelectedItem.ToString() + "')";
        ...
        {         
            ...
            string arrival3 = arrival.ToString("ddMMyyyy");
            string[] values = new string[9];
            string passport = "";
            int n;
            int place;
            ...
            Path.GetFileNameWithoutExtension(path2), passport, help, arrival3);
            ...
            checks = "check" + passport + arrival3;
            ...
            mySqlCommand2.CommandText = "INSERT INTO arr_check (passport,arrival) Values(" + passport + ",'" + arrival + "')";
        ...
        private void Button6_Click_1(object sender, EventArgs e)
        {
            DateTime arrival = monthCalendar1.SelectionRange.Start.Date;
            string arrival2 = arrival.ToString("yyyy-MM-dd");
            string arrival3 = arrival.ToString("dd-MM-yyyy");
            string arrival4 = arrival.ToString("ddMMyyyy");
            ...
            string help = @"\";
            var fileName2 = String.Format("{0}{1}{2}{3}",
            Path.GetFileNameWithoutExtension(path2), passport, help, arrival2);
            var result = Path.Combine(Path.GetDirectoryName(path2), fileName2);
            Directory.CreateDirectory(Path.Combine(Path.GetDirectoryName(path2), fileName2));

            checks = "check" + passport + arrival4;
